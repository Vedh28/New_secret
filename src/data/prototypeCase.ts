...
const puneIntelligence: CaseIntelligence = {
  ...
  network_dna: { density: 0.18, centralization: 0.58, community_count: 1, clustering: 0.1, bridge_dependence: "LOW", bridge_ratio: 0.1, temporal_volatility: 0.62, communication_activity: "LOW", transaction_anomaly: "LOW", evidence_coverage: 54, fragmentation: 0.28 },
...
export const prototypeIntelligence: CaseIntelligence = {
  ...
  network_dna: { density: 0.32, centralization: 0.68, community_count: 3, clustering: 0.2, bridge_dependence: "HIGH", bridge_ratio: 0.4, temporal_volatility: 0.76, communication_activity: "MEDIUM", transaction_anomaly: "LOW", evidence_coverage: 61, fragmentation: 0.54 },
